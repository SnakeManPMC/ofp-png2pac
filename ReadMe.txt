...
If executed with only one parameter, TGA file specified by parameter is
converted with destination type autodetection.

png2pac (C) 2004 feersum.endjinn@luukku.com
